...
exports.getSubCategories = async(req, res) => {
    try{
       const subCategories = await SubCategory.aggregate([ //Obtención de modelos relacionados
           {
               $lookup: {   
                   from: "category",
                   localField: "category",
...
exports.updateSubCategoryById = async(req, res) => {
    try{
        ...
        const obj = req.body;
        const updateSubCategory = await SubCategory.findByAndUpdate(id,obj, {new: true});
